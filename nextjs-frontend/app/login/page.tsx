...
import { BookOpen, Lock, Eye, EyeOff, User, Loader2 } from "lucide-react"
...
export default function LoginPage() {
  ...
  return (
    ...
    // </div>
    <AuroraBackground className="min-h-screen flex items-center justify-center p-4 pt-0" >
        ...
        <Card className="border-border/50 shadow-2xl backdrop-blur-sm bg-card/95">
          <CardHeader className="space-y-1">
            ...
            <CardDescription className="text-center">Đăng nhập để tiếp tục đọc light novel yêu thích</CardDescription>
          </CardHeader>
