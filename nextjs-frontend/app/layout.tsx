...
export const metadata: Metadata = {
  title: "NovelVerse - Đọc Light Novel Online",
  description: "Website đọc light novel với phong cách anime/manga hiện đại",
  generator: "v0.app",
};
...
export default async function RootLayout({
  ...
  let user: UserOut | null|undefined = null;
  ...
  try {
    ...
    user = null; // Ensure user is null on any failure
  }
              ...
              <div className="min-h-screen bg-background">
                ...
                <footer className="border-t border-border mt-4">
                  <div className="container mx-auto px-4 py-2">
                    ...
                    <div className="text-center text-sm text-muted-foreground border-border pt-2">
